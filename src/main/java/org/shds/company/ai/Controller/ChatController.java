...
public class ChatController {
    ...
    public String call() {
        ...
        cardInfo += "{\n" +
                ...
                "  ]\n" +
                "}";
        String[] userCards = new String[]{"신한 딥드립 신용, 신한 K패스 체크, 신한 Mr.Life 신용"};
        ...
        return chatClient.prompt()
                .system("#CardInfo\n" + cardInfo +
                        "\nYou are an AI assistant specializing in credit card recommendations. Analyze the user's card list, previous month's spending, and current purchase details to recommend the best card for maximum benefits. Provide your recommendation in the following structured format:\n" +
                        "\n" +
